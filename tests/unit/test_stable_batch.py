...
from workloads.cybermarket.batch import runner as batch
from workloads.cybermarket.maintenance import (
...
class StableTableTest(unittest.TestCase):
    def test_fact_bootstraps_bronze_once_and_replaces_only_current_files(self):
        ...
        with patch(
            "kest.lakehouse.tables.parquet_files_to_data_files",
...
class MaintenanceTest(unittest.TestCase):
    ...
    def test_cleanup_matches_only_old_versioned_namespaces_and_defaults_to_dry_run(
        ...
        with (
            patch(
                "workloads.cybermarket.maintenance.catalog",
                return_value=iceberg_catalog,
            ),
