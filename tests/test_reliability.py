...
from workload.lakehouse.publication import publish_pointer
...
class ReliabilityTest(unittest.TestCase):
    ...
    def test_publish_uses_cas_and_rejects_stale_pointer(self):
        ...
        client = FakeS3()
        with patch("workload.lakehouse.publication.s3_client", return_value=client):
        ...
        with (
            patch("workload.lakehouse.publication.s3_client", return_value=stale),
